...
I consider myself an ecologist with expertise as **data steward** and in **research software engineering**: I am part of the [Data Stewardship Network](https://www.lib4ri.ch/data-stewardship-network) and an active member of the [Research Software Engineering community of Switzerland](https://rse.swiss/about/). This means the analyses I deliver come with the data management and software craft to keep them usable after the project ends.
...
-   **Ecosystem and food-web modelling** — Ecopath with Ecosim / [`Rpath`](notebooks/ecopath/Ecopath_with_Ecosim.qmd) for modelling how communities respond to warming, nutrients and exploitation.

-   **Ecological forecasting** — predicting how populations, communities and ecosystem variables will evolve, with the uncertainty of each forecast stated. I routinely forecast using [empirical dynamic modelling](notebooks/edm/EDM_intro.qmd), autocorrelation structures, and nonlinear trends and seasonality with GAMs and/or [Gaussian processes](https://en.wikipedia.org/wiki/Gaussian_process).
