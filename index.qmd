...
::: {.home-actions}
<a class="btn btn-outline-dark btn-lg" href="mailto:leocapi07@gmail.com">{{< fa envelope >}}&nbsp; Email</a>
<a class="btn btn-outline-dark btn-lg" href="cv.pdf">{{< fa file-pdf >}}&nbsp; CV</a>
:::
