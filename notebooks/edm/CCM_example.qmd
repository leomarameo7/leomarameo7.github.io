...
-   In a tightly coupled ecological system, that assumption is often false. **Convergent Cross Mapping (CCM)** [@sugihara_2012] was built specifically for non-separable, dynamically coupled variables [@chang_empirical_2017].
...
-   @sugihara_2012 — the original CCM paper, introducing the method used throughout this notebook.
