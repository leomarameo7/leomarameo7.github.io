...
#### 25–27 August 2026 — *Workshop on Advanced Empirical Dynamic Modelling (EDM)*

**Eawag, Dübendorf, Switzerland.** A three-day workshop I organised, bringing together participants interested in **detecting causal relationships between variables without assuming a fixed model structure**, and in **forecasting how populations, communities and interactions respond to change over time**. Participants were expected to arrive with a basic familiarity with dynamical systems, nonparametric regression, multivariable calculus and linear algebra.
